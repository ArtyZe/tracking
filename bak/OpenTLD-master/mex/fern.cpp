...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    switch ((int) *mxGetPr(prhs[0]))
    {
        ...
        case 1:
        {
            ...
            if (nrhs != 5)
            {
                mexPrintf("fern: wrong input.\n");
                return;
            }

            if (BBOX != 0)
            {
                mexPrintf("fern: already initialized.\n");
                return;
            }
        ...
        case 2:
        {
            ...
            if (nrhs != 5 && nrhs != 6)
            {
                mexPrintf("Conf = function(2,X,Y,Margin,Bootstrap,Idx)\n");
                return;
            }
        ...
        case 4:
        {
            ...
            double *conf = mxGetPr(prhs[4]); if (mxGetN(prhs[4]) != nBBOX)
            {
                mexPrintf("Wrong input.\n");
                return;
            }

            double *patt = mxGetPr(prhs[5]); if (mxGetN(prhs[5]) != nBBOX)
            {
                mexPrintf("Wrong input.\n");
                return;
            }
            ...
            double nTest  = nBBOX * probability; if (nTest <= 0)
            {
                return;
            }
        ...
        case 5:
        {
            ...
            if (nrhs != 4)
            {
                mexPrintf("patterns = fern(5,img,idx,var)\n");
                return;
            }
